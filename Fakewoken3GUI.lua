...
wait(4)
FrameBack:TweenPosition(UDim2.new(0.635, 0,0.16, 0))
wait(3)
FrameBack:TweenPosition(UDim2.new(1.5, 0,0.16, 0))
...
--for i,v in pairs(v.StatusFolder:GetChildren()) do print(v.Name) end
--[[]
...
elseif plr.Character.StatusFolder:FindFirstChild('ParryCD') and autoparry == true and PlayerFeinted == false then
        pcall(function()
            plr.Character.StatusFolder:FindFirstChild('ParryCD'):Destroy()
        end)
        parry()
...
elseif plr.Character.StatusFolder:FindFirstChild('FeintCD') and autoparry == true and PlayerFeinted == false then
        pcall(function()
            plr.Character.StatusFolder:FindFirstChild('ParryCD'):Destroy()
...
elseif plr.Character.StatusFolder:FindFirstChild('Stun') and autoparry == true and PlayerFeinted == false then
